...
class AccountTest {
    ...
    /***
     * НЕПРОХОДЯЩИЙ тест на то, что значение максимального кредита
    ...
    /***
     * НЕПРОХОДЯЩИЙ тест на то что собственно меняется значение максимального
    ...
    /***
     * НЕПРОХОДЯЩИЙ тест на функцию внесения суммы: хотя
    ...
    /***
     * НЕПРОХОДЯЩИЙ тест на попытку списать сумму равную максимальному
